...
class ChessDataset(BaseDataset):
    ...
    def download(self) -> None:
        ...
        try:
            ...
            raise RuntimeError(f"Error decompressing the zstd file: {e}")
    
    def _parse_pgn_game(self, game: chess.pgn.Game) -> Optional[Tuple[str, str, float, datetime.datetime, Dict[str, Any]]]:
        """
