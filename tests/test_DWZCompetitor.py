...
class TestDWZ(unittest.TestCase):
    def test_Improvement(self):
        initial_rating = 100
        player1 = DWZCompetitor(initial_rating=initial_rating)

        # if player1 beats someone with a high rating, their rating should go up.
        for _ in range(10):
            player2 = DWZCompetitor(initial_rating=800)
    ...
    def test_Decay(self):
        ...
        # if player1 beats someone with a high rating, their rating should go up.
        for _ in range(10):
            player2 = DWZCompetitor(initial_rating=100)
