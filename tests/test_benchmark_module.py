...
class TestBenchmarkModule(unittest.TestCase):
    def setUp(self):
        ...
        self.compare_func = lambda a, b, attributes=None: attributes.get("score_a", 0) > attributes.get("score_b", 0) if attributes else None
    ...
    def test_evaluate_competitor(self, mock_evaluate, mock_train):
        ...
        mock_history.calculate_metrics = MagicMock(side_effect=[
        ...
        mock_history.accuracy_by_prior_bouts = MagicMock(return_value={
    ...
    def test_evaluate_competitor_without_optimization(self, mock_evaluate, mock_train):
        ...
        # Mock the calculate_metrics method to return known values
        mock_history.calculate_metrics = MagicMock(return_value={
            'accuracy': 0.67,
            'precision': 0.5,
            'recall': 1.0,
            'f1': 0.67,
